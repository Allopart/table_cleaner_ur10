...
{
  ros::init(argc, argv, "spoon_vis_seg");
...
*/
  ...
  ros::Subscriber mask_coeff = nh.subscribe("/spoon/mask_coeff", 1, mask_callback);
...
//message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/spoon/spoon_rect_depth", 1);


  pcl_pub = nh.advertise<sensor_msgs::PointCloud2> ("/spoon/vis_seg/pcl", 1);
