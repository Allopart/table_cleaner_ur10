...
{
  ros::init(argc, argv, "knife_vis_seg");
...
*/
  ...
  ros::Subscriber mask_coeff = nh.subscribe("/knife/mask_coeff", 1, mask_callback);
...
//message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/knife/knife_rect_depth", 1);


  pcl_pub = nh.advertise<sensor_msgs::PointCloud2> ("/knife/vis_seg/pcl", 1);
