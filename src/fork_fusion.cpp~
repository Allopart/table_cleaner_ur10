...
{
  ros::init(argc, argv, "knife_fusion");
  
  ros::NodeHandle nh;
  message_filters::Subscriber<sensor_msgs::PointCloud2> pcl_sub(nh, "/knife/pcl_seg/pcl", 1);
  message_filters::Subscriber<sensor_msgs::PointCloud2> rgbd_sub(nh, "/knife/vis_seg/pcl", 1);
  final_pub = nh.advertise<sensor_msgs::PointCloud2> ("/knife/final/pcl", 1);
