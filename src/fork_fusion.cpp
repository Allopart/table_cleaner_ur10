...
{
  ros::init(argc, argv, "fork_fusion");
  
  ros::NodeHandle nh;
  message_filters::Subscriber<sensor_msgs::PointCloud2> pcl_sub(nh, "/fork/pcl_seg/pcl", 1);
  message_filters::Subscriber<sensor_msgs::PointCloud2> rgbd_sub(nh, "/fork/vis_seg/pcl", 1);
  final_pub = nh.advertise<sensor_msgs::PointCloud2> ("/fork/final/pcl", 1);
