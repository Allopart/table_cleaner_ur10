...
{
  ros::init(argc, argv, "spoon_fusion");
  
  ros::NodeHandle nh;
  message_filters::Subscriber<sensor_msgs::PointCloud2> pcl_sub(nh, "/spoon/pcl_seg/pcl", 1);
  message_filters::Subscriber<sensor_msgs::PointCloud2> rgbd_sub(nh, "/spoon/vis_seg/pcl", 1);
  final_pub = nh.advertise<sensor_msgs::PointCloud2> ("/spoon/final/pcl", 1);
